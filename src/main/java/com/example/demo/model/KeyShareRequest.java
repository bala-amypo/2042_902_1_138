...
public class KeyShareRequest {
    ...
    protected void onCreate() {
        ...
        if (requestedAt == null) requestedAt = Timestamp.valueOf(LocalDateTime.now());
    }
    
    public Timestamp timestamp() { return this.requestedAt != null ? this.requestedAt : this.createdAt; }
